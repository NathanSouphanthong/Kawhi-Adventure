/* [LoseFrame.java]
 * A program that displays when user loses the game. It asks user to replay or to quit the game
 * June 12th, 2019
 * @author: Jerry Jiao
 */
...
class LoseFrame extends JFrame { 
  ...
  LoseFrame() { 
    ...
    //Add all buttons to the panel according to border layout
  ...
  private class GameAreaPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {   
      ...
      g.drawString("YOU LOSTTTTTTTTTTT", maxX/2-500,100);
  ...
  //inner class for quitting button press
